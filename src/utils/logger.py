...
class Logger:
    def __init__(self, args, i):
        ...
        if args.tensorboard:
            ...
            self.writer = None
        self.log_per_updates = args.log_per_updates[i]
        self.summary_per_updates = args.summary_per_updates[i]
    ...
    def update(self, stats):
        ...
        if updates % self.log_per_updates == 0:
            ...
            msg = f'[{dataset}] epoch {self.epoch} updates {updates} {stats_str}'
    ...
    def log_eval(self, valid_stats):
        ...
        if eval_score > self.best_eval:
            ...
            valid_stats_str += f' [BEST: {self.best_eval_str}]'
